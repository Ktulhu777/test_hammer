"""
Django settings for test_hammer project.
...
SECRET_KEY = 'django-insecure-5^4_@wkc+*5=35t&+%z+^88_p%@oe=d^l-t$3!t@r6l^q*(ht3'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / "static"]  # Если у вас есть статические файлы в папке static
